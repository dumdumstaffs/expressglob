  ...
  <div className="mx-auto w-full sm:w-8/12">
    <div className="text-center mt-24">
      ...
      <p className="font-thin text-xl">
        ...
        contact{" "}
        <a className="text-gray-800 font-thin underline">Customer Service</a>.
      </p>
      <p className="font-thin text-lg sm:text-2xl text-gray-800 mt-24">
        Watch List
      </p>
      <p className="font-medium mt-8 text-sm">
        {" "}
