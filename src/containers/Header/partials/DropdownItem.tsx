...
import { DropdownSubMenuFooter, DropdownSubMenuItem, SubMenuProps } from "./DropdownSubMenu"
                ...
                <li className={`fxg-dropdown__item ${activeTab === tab ? "fxg-dropdown__item--open" : ""}`}>
                    ...
                    <div className="fxg-dropdown__sub-menu">
                        <div className="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
                            {
                                items.map((item, i) => (
                                    <DropdownSubMenuItem key={i} title={item.title} href={item.href} isFirst={i === 0} />
                                ))
                            }
