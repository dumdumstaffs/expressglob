...
export const Sidebar = () => {
  ...
  return (
    <div
      className="fxg-dropdown fxg-global-nav"
      style={{ height: smallScreen ? "100vh" : "inherit" }}
    >
      <div className="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
        <DropdownItem
          ...
          items={[
            ...
            },
            {
              ...
              href: "/shipping/schedule-manage-pickups",
            },
        ...
        <DropdownItem
          ...
          items={[
            ...
            { title: "ModernExpress Service Guide", href: "/service-guide" },
            {
