...
import { Search, Sidebar, Userbar } from "./partials/bars";
            ...
            <div className="headerv2 aem-GridColumn aem-GridColumn--default--12">
              ...
              <header className="fxg-header fxg-header--sticky">
                ...
                <nav
                  className={`fxg-nav ${
                    store.sidebarOpen
                      ? "fxg-nav--mobile-menu-open fxg-wiki-nav--mobile-menu-open"
                      : ""
                  } ${store.searchOpen ? "fxg-nav--search-open" : ""}`}
                >
                  <div className="fxg-wrapper">
                    <Link
                      ...
                      target="_self"
                      aria-label="Broadway Transit Logo"
                    >
                      <Logo />
                    </Link>
                    {/* DROPDOWN */}
                    ...
                    <div className="fdx-utilityWrap">
                      ...
                      <div className="fxg-user-options">
                        {/* USERBAR */}
                        <div
                          className={`fxg-user-options__option fxg-user-options__sign-in ${
                            store.userbarOpen ? "fxg-dropdown__item--open" : ""
                          }`}
                        ...
                        <button
                          ...
                          className={`hamburger hamburger--slider fxg-user-options__menu-btn ${
                            store.sidebarOpen ? "is-active" : ""
                          }`}
                          type="button"
                ...
                {(store.sidebarOpen || store.userbarOpen) && (
                  <div
                    className="fxg-overlay"
