...
export const TrackingNav = () => {
  ...
  return (
    <nav
      ...
      className="relative shadow-md sm:shadow-none border-solid border-0 border-b-2 border-gray-200"
    >
      <div className="flex justify-between items-center py-4 px-2 sm:px-4 lg:w-8/12 mx-auto">
        ...
        <h2 id="menuTitle" className="text-lg text-gray-600 font-thin m-0">
          Broadway Transit<sup className="tracking-super-script">®</sup>
          &nbsp;Tracking
        </h2>
        <ul
          role="menubar"
        ...
        >
          <li role="menuitem" className="">
            <a
              ...
              onClick={Controller.toggleTrackNew}
            >
              Track Another Shipment
            </a>
          </li>
          <li role="menuitem" className="">
            <Link href="/support" className="text-md cursor-pointer">
              Help
            </Link>
          </li>
        </ul>
      ...
      <div
        ...
        } bg-white shadow-md shadow-gray-300 sm:hidden top-[60px] absolute w-full z-10 border-solid border-0 border-t-2 border-gray-200`}
      >
        <a
          className="px-2 py-5 block text-gray-900 cursor-pointer"
          onClick={mobileToggleTrackNew}
        >
          Track Another Shipment
        </a>
        <Link
