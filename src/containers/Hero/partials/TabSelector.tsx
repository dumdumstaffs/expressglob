...
export const TabSelector = ({ activeTab, handleChange }: Props) => {
    return (
        <ul className="fxg-cube-container" role="tablist">
            <li
                id="cubeOnePar"
                className={`fxg-cube ${activeTab === "ship" && "fxg-cube--active"} notTarget`}
                role="tab"
                tabIndex={0}
            >
                <button
            ...
            <li
                id="cubeTwoPar"
                className={`fxg-cube ${activeTab === "track" && "fxg-cube--active"} notTarget`}
                role="tab"
                tabIndex={0}
            >
                <button
            ...
            <li
                id="cubeThreePar"
                className={`fxg-cube ${activeTab === "location" && "fxg-cube--active"} notTarget`}
                role="tab"
                tabIndex={0}
            >
                <button
...
const ShipIcon = () => (
    ...
    >
        ...
        <g
            xmlns="http://www.w3.org/2000/svg"
            className="fxg-cube__icon-white"
        >
            <polyline
                points="21.66 38.56 21.66 22.12 66.28 1.12 110.81 22.12 110.81 64.14 66.28 85.15 52.06 78.16"
                fill="none"
