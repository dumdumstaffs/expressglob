...
import { LoaderError } from "@web/components/Loader";
import tabStyles from "@web/styles/modules/tab.module.css";
    ...
    >
      <div className="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
        <div className="rate_ship_app appBaseComponent aem-GridColumn aem-GridColumn--default--12">
          ...
          <div
            className={tabStyles.shipContainer}
            style={{ height: state.loading ? 400 : undefined }}
          >
            {state.loading ? (
                  ...
                  <div className="fdx-o-grid__row fdx-o-grid__row--center fdx-o-grid__row--guttered-small">
                    <div className="fdx-o-grid__item--12 fdx-o-grid__item--7@medium container-width">
                      <div className="fdx-u-mb--8 fdx-u-align--center">
                        <h1
                          id="magr-heading"
                          className="fdx-u-font-size--h3"
                          style={{ marginBottom: "25px" }}
                        >
                          {/**/}
                          {/**/} Calculate Broadway Transit shipping rates.{" "}
                        </h1>
                        {state.error && <LoaderError size="small" />}
                        <form
                          onSubmit={onSubmit}
                          className="fxg-form input-group"
                        >
