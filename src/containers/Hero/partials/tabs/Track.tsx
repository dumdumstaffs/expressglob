                ...
                <form className="fxg-form" onSubmit={handleSubmit}>
                  <div className="fxg-field">
                    <input
                      ...
                      required
                      title="Enter a Broadway Transit tracking number to review shipping details."
                      aria-required="true"
                    ...
                    <span className="fxg-u-sronly">
                      {`"Enter a Broadway Transit tracking number to review shipping
                      details."`}
                    </span>
                    <span
                    ...
                    <div className="fxg-wrapper fxg-featured-offer-wrapper   ">
                      ...
                      >
                            ...
                            <div className="richtext parbase aem-GridColumn aem-GridColumn--default--12">
                              ...
                              >
                                <p>
                                  ...
                                  <br /> Learn how Broadway Transit Delivery
                                  Manager
                                  <sup>®</sup> can help ensure your deliveries
                                  meet your schedule - not the other way.
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <div
                          ...
                          data-mobile-image="/content/dam/fedex/us-united-states/Broadway Transit-Office/images/2018/Q4/delivery_driver_home_express_shipping_1511023269.jpg"
                          data-mobile-alt="Woman receiving package delivery at home"
                          data-main-image="/content/dam/fedex/us-united-states/Broadway Transit-Office/images/2018/Q4/delivery_driver_home_express_shipping_1511023269.jpg"
              ...
              <div className="aem-Grid aem-Grid--12 aem-Grid--default--12 ">
                <div className="title_v1 aem-GridColumn aem-GridColumn--default--12">
                  <h2 className="fxg-title fxg-title--default center    ">
                    Enter up to 30 Broadway Transit tracking numbers
                  </h2>
                </div>
              </div>
              <form
