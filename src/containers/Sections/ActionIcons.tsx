        ...
        <>
            <div className="advanced_table_v1 table parbase">
                ...
                >
                    ...
                    >
                        ...
                        <thead>
                            <tr>
                                <TableIcon title="drop off a package" href={links.drop} image="/images/icons/icon_courier_purple_lg_1637809911.png" />
                                <TableIcon title="Redirect a package" href={links.redirect} image="/images/icons/icon_delivery_purple_lg_2143296207.png" />
                                <TableIcon title="Store hours and services" href={links.store} image="/images/icons/retail-services.svg" />
                                <TableIcon title="Service alerts" href={links.service} image="/images/icons/icon_alert_purple_lg.png" />
                                <TableIcon title="Return a package" href={links.return} image="/images/icons/icon_returns_purple_lg_1184917500.png" />
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
            ...
            <div className="column_control_v1">
                ...
                <div className="row" style={{ backgroundColor: "" }}>
                    {/* 5 Columns */}
                    <RowIcon title="drop off a package" href={links.drop} image="/images/icons/icon_courier_purple_lg_1637809911.png" />
                    <RowIcon title="Redirect a package" href={links.redirect} image="/images/icons/delivery.svg" />
                    <RowIcon title="Store hours and services" href={links.store} image="/images/icons/icon_retail_services_purple_med.png" />
                    <RowIcon title="Service alerts" href={links.service} image="/images/icons/icon_alert_purple_lg.png" />
                    <RowIcon title="Return a package" href={links.return} image="/images/icons/icon_returns_purple_lg_1184917500.png" />
                </div>
                {/* COLUMN CONTROL END */}
            </div>
        </>
...
const RowIcon = ({ title, href, image }: IconProps) => (
    <div
        className="fxg-col col-sm-2 fxg-desktop--hide fxg-tablet--hide">
