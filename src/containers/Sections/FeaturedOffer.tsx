        ...
        <div className="featured_offer_v2">
            <div className="fxg-wrapper fxg-featured-offer-wrapper">
                ...
                >
                    {
                        smallScreen ? (
                            offer.smImageDir === "bottom" ? <DetailDisplay imageFirst={false} offer={offer} /> : <DetailDisplay imageFirst={true} offer={offer} />
                        ) : (
                            offer.imageDir === "right" ? <DetailDisplay imageFirst={false} offer={offer} /> : <DetailDisplay imageFirst={true} offer={offer} />
                        )
                    }
...
const DetailDisplay = ({ imageFirst, offer }: { imageFirst: boolean, offer: Offer }) => (
    <>
        {
            imageFirst ? (
                <>
...
const Detail = ({ title, href, linkText, desc, largeText }: Omit<Offer, "image" | "layout2">) => (
            ...
            <div className="richtext parbase aem-GridColumn aem-GridColumn--default--12">
                ...
                >
                    <p>
                        {
                            largeText ? (
                                <span className="fxg-font-size-18">
                                    {desc}
                                </span>
                            ) : desc
                        }
