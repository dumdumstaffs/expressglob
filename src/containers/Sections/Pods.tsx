...
const ITEMS = [
  {
    ...
    desc: "Help keep your deliveries safe when you ask us to hold packages at one of thousands of nearby Broadway Transit® locations.Track your package to begin.",
  },
  {
